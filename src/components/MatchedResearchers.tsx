        ...
        <table className="w-full text-sm border-collapse table-fixed">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th className="px-4 py-4 text-left font-semibold text-gray-700 whitespace-nowrap w-[10%]">部署</th>
              ...
              <th className="px-1 py-4 text-left font-semibold text-gray-700 whitespace-nowrap w-[48%]">
              ...
              <th className="pl-1 pr-4 py-4 text-center font-semibold text-gray-700 whitespace-nowrap w-[6%]">お気に入り</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-200">
            {researchers.map((researcher: any) => (
              <tr key={researcher.researcher_info?.researcher_id || researcher.matching_id} className="hover:bg-gray-50">
                ...
                <td className="px-1 py-4 text-gray-700 text-xs">
                  {(() => {
